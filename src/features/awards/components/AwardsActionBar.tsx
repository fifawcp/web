 ...
 * right. Sits above the cards so the primary actions are visible immediately
 * without scrolling.
 */
export function AwardsActionBar({ remaining, canReset, isSaving, onReset, onSave }: Props) {
